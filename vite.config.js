    ...
    plugins: [
        ...
        VitePWA({
            ...
            manifest: {
                ...
                description: 'Calendario semanal offline de estrenos anime con recomendaciones basadas en AniList.',
                theme_color: '#de6a2d',
            ...
            workbox: {
                ...
                runtimeCaching: [
                    ...
                    {
                        urlPattern: ({ url }) => url.hostname === 's4.anilist.co' || url.hostname === 'anilist.co',
                        handler: 'CacheFirst',
                        options: {
